...
public enum SpriteSheet {
    ...
    //Felix: implement farmthings spritesheet
    FARMTHINGS("farmthings.png", 16, 16),
    //PP: implement object file
    OBJECTS("objects.png", 16, 16),
    //import own file
    FINISHEDLAYOUT("finishedlayout.png", 32, 32),
    CROPS("crops.png", 32,32),
     CHICKEN("chick_48x64.png",48,64),
    BALROG("balrog.png",1,1),
    HARVEST("Harvest.png",16,16),
    FLOORTILES("floor-tiles.png",32,32),
    BLUEFIRE("Bluefire.png",256,256),
    ROGUEITEMS("roguelikeitems.png",16,16),
    EXPLOSION("explosion.png",32,32),
    CHARACTER_HIT("characterhit.png" ,32, 32),
    LIGHTNING_FILE("lightning.png",160,160);
